...
En primer lugar, se examinará la hibridación en la aplicación de **Google Maps**. En segundo lugar, ese analizará la aplicación de **Whats App** y, en tercer y último lugar, el uso del **reloj inteligente o Smart Watch**. Las tres aplicaciones cuentan con diferentes medios que conviven entre sí para formar el aplicativo e ilustran cómo la hibridación puede ser una fuerza impulsora para la innovación y la creatividad en el mundo digital.
# GOOGLE MAPS
